...
terrain.texture.canvas = terrain.texture.canvas.getContext('2d')
terrain.texture.canvas.fillStyle = 'red'
terrain.texture.canvas.fillRect(0,0, terrain.texture.width, terrain.texture.height)
